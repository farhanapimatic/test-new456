...
public class RelatedItems145 
        implements java.io.Serializable {
    private static final long serialVersionUID = 5590013205703676478L;
    private RelationshipEnum relationship;
    private String relationshipType;
    private Integer relatedItemCount;
    private Integer relatedItemPageCount;
    private Integer relatedItemPage;
    private List<RelatedItem144> relatedItem;
    /** GETTER
    ...
    public List<RelatedItem144> getRelatedItem ( ) { 
    ...
    public void setRelatedItem (List<RelatedItem144> value) { 
